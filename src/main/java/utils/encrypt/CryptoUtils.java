...
public final class CryptoUtils {
    ...
    public static String decrypt(String message, String desPrivateKey) throws Exception {
        ...
        DESKeySpec desKeySpec = new DESKeySpec(desPrivateKey.getBytes(StandardCharsets.UTF_8));
        SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("DES");
        SecretKey secretKey = keyFactory.generateSecret(desKeySpec);
        IvParameterSpec iv = new IvParameterSpec(desPrivateKey.getBytes(StandardCharsets.UTF_8));
